...
W~badanym systemie rolę magazynu podręcznego pełni Redis, uruchomiony jako odrębna usługa. Trafienie eliminuje ze~ścieżki żądania zapytanie do~relacyjnej bazy danych, wymaga jednak wymiany komunikatów z~pamięcią podręczną. Stan bufora stanowi jeden z~wymiarów macierzy badawczej: w~rozdziale~\ref{cha:MetodologiaBadan} opisano scenariusze odczytu wykonane zarówno przy buforze wypełnionym, jak i~przy wymuszonym jego pominięciu, a~w~rozdziale~\ref{cha:AnalizaWydajnosci} porównano wartości centralne oraz rozrzut czasów uzyskanych w~obu stanach. Pominięcie bufora wymuszano dedykowanym nagłówkiem żądania, bez zmiany logiki punktu końcowego.
